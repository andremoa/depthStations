...
public:
    ...
    bool recvfromAck(uint8_t* buf, uint8_t* len, uint8_t* from = NULL, uint8_t* to = NULL, uint8_t* id = NULL, uint8_t* flags = NULL, uint8_t minutes = NULL, uint8_t seconds = NULL);
    ...
    void acknowledge(uint8_t id, uint8_t from, uint8_t minutes = NULL, uint8_t seconds = NULL);
protected:
